  ...
  Scenario Outline: Admin and Practice Manager task management flow
   ...
   And I click on the save button
    ...
    Examples:
      ...
      | Dental Checkup | KhajaPM    | KhajaPmAlpha alpha | 2024      | NOV        | 4         | 2024        | NOV          | 5           | High     | Dentalcheckup | Iam unable to do it | Iam taking up the task | completed the task | alpha pm alpha |